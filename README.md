...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/anci
```

A live public deployment of this template is available at [https://anci.templates.workers.dev](https://anci.templates.workers.dev)
